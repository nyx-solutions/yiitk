<?php
     ...
     * ```
     */
    class HashableBehavior extends AttributeBehavior
    {
        /**
        ...
        /**
         * @var bool whether to add the hash inside {}
         */
        public bool $useCurlyBrackets = true;
        ...
        protected function generateHash(): string
        {
            ...
            return HashableHelper::hash($this->useCurlyBrackets);
        }
        ...
        protected function makeUnique(string $hash): string
        {
            ...
            while (!$this->validateHash($uniqueHash)) {
                $uniqueHash = $this->generateUniqueHash($hash);
            }
         ...
         */
        protected function generateUniqueHash(string $baseHash): string
        {
