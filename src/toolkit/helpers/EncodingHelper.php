<?php
    ...
    class EncodingHelper
    {
        ...
        public static function toUTF8($text)
        {
            ...
            for ($i = 0; $i < $max; $i++) {
                ...
                if ($c1 >= "\xc0") { //Should be converted to UTF8, if it's not UTF8 already
                    ...
                    if (isset(static::$win1252ToUtf8[ord($c1)])) { //found in Windows-1252 special cases
         ...
         * @return mixed
         */
        protected static function textLength($text)
        {
        ...
        protected static function utf8Decode($text, $option)
        {
            if ($option == self::WITHOUT_ICONV || !function_exists('iconv')) {
                $o = utf8_decode(str_replace(array_keys(static::$utf8ToWin1252), array_values(static::$utf8ToWin1252), static::toUTF8($text)));
            } else {
