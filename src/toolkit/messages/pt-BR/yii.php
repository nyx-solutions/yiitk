<?php
    ...
    return [
        ...
        'The format of {attribute} is invalid.' => 'O formato do campo "{attribute}" é inválido.',
        ...
        '{attribute} "{value}" has already been taken.' => 'O campo "{attribute}" com o valor "{value}" já foi utilizado.',
        '{attribute} cannot be blank.' => 'O campo "{attribute}" é obrigatório.',
        '{attribute} is invalid.' => 'O campo "{attribute}" deve conter uma entrada válida.',
        '{attribute} is not a valid URL.' => 'O campo "{attribute}" deve conter um endereço (URL) válido.',
        '{attribute} is not a valid email address.' => 'O campo "{attribute}" não é um endereço de e-mail válido.',
        '{attribute} must be "{requiredValue}".' => 'O campo "{attribute}" deve ser igual a "{requiredValue}".',
        '{attribute} must be a number.' => 'O campo "{attribute}" deve ser numérico.',
        '{attribute} must be a string.' => 'O campo "{attribute}" deve ser um texto.',
        '{attribute} must be an integer.' => 'O campo "{attribute}" deve ser um número inteiro.',
        '{attribute} must be either "{true}" or "{false}".' => 'O campo "{attribute}" deve ser "{true}" ou "{false}".',
        '{attribute} must be greater than "{compareValue}".' => 'O campo "{attribute}" deve ser maior que "{compareValue}".',
        '{attribute} must be greater than or equal to "{compareValue}".' => 'O campo "{attribute}" deve ser maior ou igual a "{compareValue}".',
        '{attribute} must be less than "{compareValue}".' => 'O campo "{attribute}" deve ser menor que "{compareValue}".',
        '{attribute} must be less than or equal to "{compareValue}".' => 'O campo "{attribute}" deve ser menor ou igual a "{compareValue}".',
        '{attribute} must be no greater than {max}.' => 'O campo "{attribute}" não pode ser maior que {max}.',
        '{attribute} must be no less than {min}.' => 'O campo "{attribute}" não pode ser menor que {min}.',
        '{attribute} must be repeated exactly.' => 'O campo "{attribute}" deve conter o mesmo valor do campo "{compareValue}".',
        '{attribute} must not be equal to "{compareValue}".' => 'O campo "{attribute}" deve ser diferente de "{compareValue}".',
        '{attribute} should contain at least {min, number} {min, plural, one{character} other{characters}}.' => 'O campo "{attribute}" deve conter pelo menos {min, number} {min, plural, one{caractere} other{caracteres}}.',
        '{attribute} should contain at most {max, number} {max, plural, one{character} other{characters}}.' => 'O campo "{attribute}" deve conter no máximo {max, number} {max, plural, one{caractere} other{caracteres}}.',
        '{attribute} should contain {length, number} {length, plural, one{character} other{characters}}.' => 'O campo "{attribute}" deve conter {length, number} {length, plural, one{caractere} other{caracteres}}.'
    ];
